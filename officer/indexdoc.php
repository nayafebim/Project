            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white border border-green-700">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="border-t">
                                <td class="py-2 px-4 border"><?= $result["organization_name"] . " " ?></td>
                                <!-- <td class="py-2 px-4 border"><?= $result["organization_name"]; ?></td> -->
                                <td class="py-2 px-4 border">
                                    <a href="fillstd.php?organization_id=<?= $result['organization_id'] ?>" class="bg-orange-400 text-white px-4 py-2 rounded">ตรวจสอบรายชื่อ</a>
                                </td>
                                <td class="py-2 px-4 border">

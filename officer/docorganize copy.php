            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    if ($result->num_rows > 0) {
                        // echo '<form action="save_supervisor.php" method="POST">';
                        echo '<div class="form-group">';
                        echo '<label for="supervisor">โปรดเลือกผู้ลงนาม:</label>';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        echo "<script>
            ...
            window.location.href = 'organization_std.php'; // Adjust the redirection
        </script>";
    } else {
        // Handle errors
        echo "<script> 

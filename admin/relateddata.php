...
<head>
    ...
    <title>จัดการข้อมูลที่เกี่ยวข้อง</title>
...
<body class="bg-gradient-to-br from-green-700 to-teal-500 text-white font-sans min-h-screen">
    ...
    <nav class="bg-green-800 p-4 flex justify-between items-center border-b border-gray-600">
        <div class="flex items-center space-x-4">
            ...
            <a href="relateddatauser.php" class="text-yellow-300 hover:text-gray-300">จัดการข้อมูล</a>
    ...
    <div class="p-4">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 text-black border border-gray-600">
            <h2 class="text-xl font-semibold mb-4">จัดการข้อมูลที่เกี่ยวข้อง</h2>
            <div class="mb-4">
                <button class="text-green-600 flex items-center space-x-2">

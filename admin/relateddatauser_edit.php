...
<head>
    ...
    <title>หน้าแก้ไขข้อมูลนิสิต</title>
            ...
            <form class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class=" p-2 rounded">
                        ...
                        <input type="text" class="w-full p-2 border border-gray-600 rounded">
                    </div>
                    <div class=" p-2 rounded">
                    ...
                    <div class=" p-2 rounded">
                        <label class="block text-sm">รหัสนิสิต</label>
                        <input type="text" class="w-full p-2 border border-gray-600 rounded">
                    </div>
                    <div class=" p-2 rounded">
                    ...
                    <div class=" p-2 rounded">
                        <label class="block text-sm">ชั้นปี</label>
                        <input type="text" class="w-full p-2 border border-gray-600 rounded">
                    </div>
                    <div class=" p-2 rounded">
                        <label class="block text-sm">เกรดเฉลี่ย</label>
                        <input type="text" class="w-full p-2 border border-gray-600 rounded">
                    </div>
                    <div class=" p-2 rounded">
                    ...
                    <div class=" p-2 rounded">
                        <label class="block text-sm">วันเกิด</label>
                        <input type="text" class="w-full p-2 border border-gray-600 rounded">
                    </div>
                    <div class=" p-2 rounded">
                        <label class="block text-sm">E-mail</label>
                        <input type="email" class="w-full p-2 border border-gray-600 rounded"
                    </div>
                    <div class=" p-2 rounded">
                        <label class="block text-sm">รหัสผ่าน</label>
                        <input type="password" class="w-full p-2 border border-gray-600 rounded">
                    </div>
                    <div class=" p-2 rounded">
                ...
                <div class="text-center mt-4">
                    <button class="bg-green-600 text-white px-4 py-2 rounded-lg border border-gray-600">บันทึก</button>
                </div>
            </form>
        </div>
    </div>

...
<header class="bg-green-800 p-4 flex justify-between items-center">
    <div class="flex items-center space-x-4">
        ...
        <a href="relateddatauser.php" class="text-yellow-300 hover:text-gray-300">ข้อมูลผู้ใช้ระบบสหกิจศึกษา</a>
        <a href="organization.php" class="text-yellow-300 hover:text-gray-300">จัดการข้อมูลสถานประกอบการสหกิจศึกษา</a>
    ...
    <div class="flex items-center space-x-2 relative">
        <span class="text-white"><?= htmlspecialchars($adminData['admin_surname'] . " " . $adminData['admin_lastname']) ?></span>
        <img id="avatarButton" type="button" class="w-10 h-10 rounded-full object-cover cursor-pointer" src="../assets/img/admin/<?= $User_ID ?>.jpg" alt="User dropdown">
        ...
        <div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 absolute right-0 mt-[150px]">
            <div class="px-4 py-3 text-sm text-gray-900">
                <div><?= htmlspecialchars($adminData['admin_surname'] . " " . $adminData['admin_lastname']) ?></div>
            </div>
            <div class="py-1">

...
<header class="bg-green-800 p-4 flex justify-between items-center">
    <div class="flex items-center space-x-4">
        ...
        <a href="insert_Intern.php" class="text-yellow-300 hover:text-gray-300">กรอกข้อมูลการเข้าร่วมโครงการสหกิจศึกษา</a>
        <a href="formdoc.php" class="text-yellow-300 hover:text-gray-300">แบบฟอร์มเอกสาร</a>
        <a href="indexreview.php" class="text-yellow-300 hover:text-gray-300">รีวิวสถานประกอบการ</a>
    ...
    <div class="flex items-center space-x-2 relative">
        <span class="text-white"><?= htmlspecialchars($studentData['student_prefix'] . "" . $studentData['student_surname'] . " " . $studentData['student_lastname']) ?></span>
        <img id="avatarButton" type="button" class="w-10 h-10 rounded-full object-cover cursor-pointer" src="../assets/img/student/<?= $User_ID ?>.jpg" alt="User dropdown">
        ...
        <div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 absolute right-0 mt-[150px]">
            <div class="px-4 py-3 text-sm text-gray-900">
                <div><?= htmlspecialchars($studentData['student_prefix'] . "" . $studentData['student_surname'] . " " . $studentData['student_lastname']) ?></div>
                <div><?= htmlspecialchars($studentData['course']) ?></div>
                <div class="font-medium truncate"><?= htmlspecialchars($studentData['student_email']) ?></div>
            </div>
            <div class="py-1">

            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-section">
                    ...
                    <div class="flex justify-end">
                        <a href="insert_position.php" class="ml-2 bg-blue-500 hover:bg-blue-600 text-white text-sm px-2 py-2 rounded-lg me-2">
                            เพิ่มตำแหน่งงาน
                        </a>
                        <a href="insert_organization.php" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg">
                    ...
                    <div class="form-group">
                        ...
                        <select id="country" name="country" class="form-select">
                            ...
                            $query = mysqli_query($conn, $sql);
                            while ($result = mysqli_fetch_assoc($query)) {
                                echo '<option value="' . $result['id'] . '">' . $result['country_name'] . '</option>';
                            }
                            ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>กรุณาเลือกจังหวัด</label>
                    ...
                    <div class="form-group">
                        <label>กรุณาเลือกอำเภอ</label>
                        <select id="amphure" name="amphure" class="form-select">
                            <option value="">กรุณาเลือกอำเภอ</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label>กรุณาเลือกตำบล</label>
...
if (isset($_POST['insert_intern'])) {
    ...
    if (empty($organization_type) || empty($organization) || empty($position)) {
        echo "
            <script>
                Swal.fire({
                    icon: 'error',
